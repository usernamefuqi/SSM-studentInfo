...
<%--引入样式--%>
<link href="/SSM_studentInfo/static/bootstrap-3.4.1-dist/css/bootstrap.min.css" rel="stylesheet">
<%--引入js文件--%>
<script src="/SSM_studentInfo/static/bootstrap-3.4.1-dist/js/bootstrap.min.js"></script>
<body>
<div id="particles-js"><canvas class="particles-js-canvas-el" width="1322" height="774" style="width: 100%; height: 100%;"></canvas></div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<form name="studentquery" action="/SSM_studentInfo/CourseHandler/query/1" method="get">
					<div class="row">
						<div class="col-md-4">
				...
				<table class="table table-striped table-hover animated fadeIn">
					...
					<c:forEach var="course" items="${requestScope.courseList}">
						<tr>
							...
							<td><a class="btn btn-default btn-sm" href="/SSM_studentInfo/CourseHandler/moditystu/${course.cid}">
								<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
								修改 </a></td>

							<td><a class="btn btn-default btn-sm" class="deleteCss"
								href="/SSM_studentInfo/CourseHandler/delete/${course.cid}">
	...
	<div class="row">
		<!--分页文字信息  -->
		<div class="col-md-6">当前第${pageInfo.pageNum }页,共有${pageInfo.pages }
			页,总计${pageInfo.total } 条记录</div>
		<!-- 分页条信息 -->
		<div class="col-md-6">
			<nav aria-label="Page navigation">
				<ul class="pagination bg-primary">
					<li><a href="/SSM_studentInfo/CourseHandler/query/1?serc=${requestScope.serc}&condition=${requestScope.condition}">首页</a></li>
					<c:if test="${pageInfo.hasPreviousPage }">
						<li><a href="/SSM_studentInfo/CourseHandler/query/${pageInfo.pageNum-1}?serc=${requestScope.serc}&condition=${requestScope.condition}"
					...
					<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
						...
						<c:if test="${page_Num != pageInfo.pageNum }">
							<li><a href="/SSM_studentInfo/CourseHandler/query/${page_Num }?serc=${requestScope.serc}&condition=${requestScope.condition}">${page_Num }</a></li>
						</c:if>
					...
					<li><a href="/SSM_studentInfo/CourseHandler/query/${pageInfo.pages}?serc=${requestScope.serc}&condition=${requestScope.condition}">末页</a></li>
				</ul>
			</nav>
		</div>
	</div>
...
<script src="/SSM_studentInfo/static/utils/scripts/bganimation.js"></script>
</body>
</html>