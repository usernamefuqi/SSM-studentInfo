...
<html>
	<head>
		...
		$(document).ready(
			function() {
				$("#tid").change(
						function() {
							$.post("/SSM_studentInfo/AjaxHandler/existTid?tid="
	...
	<script type='text/javascript' src='/SSM_studentInfo/utils/scripts/particles.js'></script>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<h5>添加教师</h5>
				<form action="/SSM_studentInfo/AdminHandler/addTeacher" method="post">
					<h6>教师编号</h6>
