...
<html>
						...
						<c:choose>
							...
							<c:otherwise>
								<label class="radio" for="radio3">
			                  		<input type="radio" name="ssex" value="男"  id="radio3" data-toggle="radio" class="custom-radio">
			               			<span class="icons">
			               				<span class="icon-unchecked"></span>
			               				<span class="icon-checked"></span>
			               			</span>
               					...
               					<label class="radio" for="radio4">
			                  		<input type="radio" name="ssex" value="女" checked id="radio4" data-toggle="radio" class="custom-radio">
			               			<span class="icons">
			               				<span class="icon-unchecked"></span>
			               				<span class="icon-checked"></span>
			               			</span>
	...
	<script type="text/javascript" src="/SSM_studentInfo/static/utils/scripts/flat-ui.js">
	</script><script src="/SSM_studentInfo/static/utils/scripts/bganimation.js"></script>
