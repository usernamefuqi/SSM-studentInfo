						...
						<h6>姓名</h6>
							...
							<c:choose>
								...
								<label class="radio" for="radio3">
			                  		<input type="radio" name="tsex" value="男"  id="radio3" data-toggle="radio" class="custom-radio">
			               			<span class="icons">
			               				<span class="icon-unchecked"></span>
			               				<span class="icon-checked"></span>
			               			</span>
               					...
               					<label class="radio" for="radio4">
			                  		<input type="radio" name="tsex" value="女" checked id="radio4" data-toggle="radio" class="custom-radio">
			               			<span class="icons">
			               				<span class="icon-unchecked"></span>
			               				<span class="icon-checked"></span>
			               			</span>
