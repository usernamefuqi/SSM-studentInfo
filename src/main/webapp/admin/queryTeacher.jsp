...
</script><link href="/SSM_studentInfo/static/utils/css/animate.css" rel="stylesheet">
	<%--引入样式--%>
...
<div class="container">
		<div class="row">
			<div class="col-md-12">
			<h5>教师管理</h5>
			<form name="studentquery" action="/SSM_studentInfo/AdminHandler/queryTea/1" method="get">
				<div class="row">
					<div class="col-md-4">
			...
			<c:forEach var="teacher" items="${requestScope.teacherList}">
				<tr>
					...
					<td><a class="btn btn-default btn-sm" href="/SSM_studentInfo/AdminHandler/modityTea/${teacher.tid}">
						<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
							修改 </a></td>

					<td><a class="deleteCss btn btn-default btn-sm"
						href="/SSM_studentInfo/AdminHandler/deleteTea/${teacher.tid}">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination bg-primary">
				<li><a href="/SSM_studentInfo/AdminHandler/queryTea/1?serc=${requestScope.serc}&condition=${requestScope.condition}">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/SSM_studentInfo/AdminHandler/queryTea/${pageInfo.pageNum-1}?serc=${requestScope.serc}&condition=${requestScope.condition}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/SSM_studentInfo/AdminHandler/queryTea/${page_Num }?serc=${requestScope.serc}&condition=${requestScope.condition}">${page_Num }</a></li>
					</c:if>
				</c:forEach>
				...
				<li><a href="/SSM_studentInfo/AdminHandler/queryTea/${pageInfo.pages}?serc=${requestScope.serc}&condition=${requestScope.condition}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
