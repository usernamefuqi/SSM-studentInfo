...
<div class="container">
		<div class="row">
			...
			<form name="studentquery" action="/SSM_studentInfo/AdminHandler/query/1" method="get">
				<div class="row">
					<div class="col-md-4">
			...
			<c:forEach var="student" items="${requestScope.slist}">
				<tr>
					...
					<td><a class="btn btn-default btn-sm" href="/SSM_studentInfo/AdminHandler/moditystu/${student.sid}">
						<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
							修改 </a></td>

					<td><a class="deleteCss btn btn-default btn-sm"
						href="/SSM_studentInfo/AdminHandler/delete/${student.sid}">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination bg-primary">
				<li><a href="/SSM_studentInfo/AdminHandler/query/1?serc=${requestScope.serc}&condition=${requestScope.condition}">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/SSM_studentInfo/AdminHandler/query/${pageInfo.pageNum-1}?serc=${requestScope.serc}&condition=${requestScope.condition}'"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/SSM_studentInfo/AdminHandler/query/${page_Num }?serc=${requestScope.serc}&condition=${requestScope.condition}">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/SSM_studentInfo/AdminHandler/query/${pageInfo.pages}?serc=${requestScope.serc}&condition=${requestScope.condition}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
