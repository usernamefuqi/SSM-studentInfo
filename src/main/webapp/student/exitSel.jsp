...
<div class="container">
			...
			<c:forEach var="exit" items="${requestScope.sesList}"
				...
				<tr>
					...
					<td><a class="btn btn-default"
						href="/SSM_studentInfo/StudentHandler/exitsel/${exit.cid }/${exit.sid}">
							退选 </a></td>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination">
				<li><a href="/SSM_studentInfo/StudentHandler/exitchoose/${sessionScope.sid }/1">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/SSM_studentInfo/StudentHandler/exitchoose/${sessionScope.sid }/${pageInfo.pageNum-1}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/SSM_studentInfo/StudentHandler/exitchoose/${sessionScope.sid }/${page_Num }">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/SSM_studentInfo/StudentHandler/exitchoose/${sessionScope.sid }/${pageInfo.pages}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
