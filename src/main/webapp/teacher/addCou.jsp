...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<h5>选择添加的课程</h5>	
			<form name="studentquery" action="/SSM_studentInfo/CoursePlanHandler/queryy/1" method="get">
				<div class="row">
					<div class="col-md-4">
		...
		<div class="col-md-12">
			...
			<c:forEach var="course" items="${sessionScope.courseList}">
				<tr>
					...
					<td>
						<a class="btn btn-default" href="/SSM_studentInfo/CoursePlanHandler/querycouplan/${course.cid}">选择 </a>
					</td>
				</tr>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination bg-primary">
				<li><a href="/SSM_studentInfo/CoursePlanHandler/queryy/1?serc=${requestScope.serc}&condition=${requestScope.condition}">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/SSM_studentInfo/CoursePlanHandler/queryy/${pageInfo.pageNum-1}?serc=${requestScope.serc}&condition=${requestScope.condition}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/SSM_studentInfo/CoursePlanHandler/queryy/${page_Num }?serc=${requestScope.serc}&condition=${requestScope.condition}">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/SSM_studentInfo/CoursePlanHandler/queryy/${pageInfo.pages}?serc=${requestScope.serc}&condition=${requestScope.condition}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
