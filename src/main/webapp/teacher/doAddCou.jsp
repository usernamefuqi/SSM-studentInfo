...
<script type="text/javascript">
	$(document).ready(
			function() {
				$("#classroom").change(
						function() {
							$.post("/SSM_studentInfo/AjaxHandler/existTime?coursetime="
...
<body><div id="particles-js"><canvas class="particles-js-canvas-el" width="1322" height="774" style="width: 100%; height: 100%;"></canvas></div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h5>新建课程</h5>
				<form action="/SSM_studentInfo/CoursePlanHandler/doaddcouplan/${sessionScope.tid}"
					method="get">
					<div class="row">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							...
							<span id="couplans" style="color: #ff0000;"></span>
							<h6>学分</h6>
							<div class="row">
								<div class="col-md-6">
