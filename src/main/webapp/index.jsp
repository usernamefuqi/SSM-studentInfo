...
<head>
    ...
    <script src="static/utils/js/bootstrap.min.js"></script>
    <style>
        .login-plane {
            padding: 2rem;
            margin-top: 3rem;
        ...
        <div class="col-md-12">
            <div class="row login-plane animated fadeIn">
                <div class="col-md-4 center-block">
                    <form method="post" name="login" id="login" action="" onsubmit="return submitHandler()">
                        <strong>账号信息</strong>
...
<script>
    ...
    function submitHandler() {
        ...
        var action = null;
        if (role == 'student') {
            action = "/SSM_studentInfo/LoginHandler/studentlogin";
            useridEle.name = "sid";
            passwordEle.name = "spassword";
        } else if (role == 'teacher') {
            action = "/SSM_studentInfo/LoginHandler/teacherlogin";
            useridEle.name = "tid";
            passwordEle.name = "tpassword";
        } else {
            action = "/SSM_studentInfo/LoginHandler/adminlogin";
