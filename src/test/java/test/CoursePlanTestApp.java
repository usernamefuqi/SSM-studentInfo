...
import com.atguigu.crud.service.CoursePlanService;
import com.atguigu.crud.service.CourseService;
...
public class CoursePlanTestApp {
    @Autowired
    private CoursePlanService coursePlanServiceImpl;
    ...
    public void insertTest() {
        ...
        coursePlan.setCid("2003");
        coursePlan.setTid("0002");
    ...
    public void selectCoursePlanByCourseclass(){
        List<CoursePlan> lists = coursePlanServiceImpl.getByCoursePlanCourseclass(1,3,"网络工程1班");
    ...
    public void getByCoursePlanTid(){
        List<CoursePlan> lists = coursePlanServiceImpl.getByCoursePlanTid(1,3,"0002");
        for (CoursePlan coursePlan : lists) {
            System.out.println(coursePlan.getCourseclass() + "\t" + coursePlan.getCoursetime() + "\t" + coursePlan.getCourseweek()
                    + "\t" + coursePlan.getCid() + "\t" + coursePlan.getTid() + "\t" + coursePlan.getClassroom()
                    + "\t" + coursePlan.getCredits() + "\t" + coursePlan.getPeriod() + "\t" + coursePlan.getTotalnum());
 ...
 /*   *
    ...
    public void getCidByCoursePlanTid(){
        List<CoursePlan> lists = coursePlanServiceImpl.getCidByCoursePlanTid(1,3,"0005");
 ...
 /*   *
   ...
   /* *
    ...
    public void existsCoursePlan(){
        ...
        n = coursePlanServiceImpl.existsCoursePlan("1005");
        if(n != null && !"".equals(n)){
